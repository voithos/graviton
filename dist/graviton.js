 ...
 */
define('graviton/sim',['util/lambda', 'util/log', 'graviton/body'], function(L, log, gtBody) {
 ...
 */
define('graviton/events',['util/lambda', 'util/log'], function(L, log) {
 ...
 */
define('graviton/timer',['util/lambda'], function(L) {
...
define('graviton/app',[
    ...
    'graviton/events',
    'graviton/timer'
], function(L, random, gtSim, gtGfx, gtBody, gtEvents, gtTimer) {
